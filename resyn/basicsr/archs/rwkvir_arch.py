...
from basicsr.module.base.vrwkv6 import Block as RWKV
...
class RWKVBlock(nn.Module):  # Add CNN block here for the RWKV improevment
    def __init__(self, dim, embed, input_resolution, n_head, n_layer, layer_id, shift_mode='q_shift_multihead', init_mode='fancy',
        ...
        self.RWKV = RWKV(n_embd=dim,embed = embed, n_head=n_head, n_layer=n_layer, layer_id=layer_id, shift_mode=shift_mode, init_mode=init_mode,
...
class BasicLayer(nn.Module): #
    def __init__(self, dim,embed, input_resolution, depth, n_head, n_layer, layer_id, shift_mode='q_shift_multihead', init_mode='fancy',
                channel_gamma=1/4, shift_pixel=1, drop_path=0., hidden_rate=4,
                post_norm=False, key_norm=False, with_cp=False,
        ...
        self.blocks = nn.ModuleList([
            RWKVBlock(dim=dim,embed=embed, input_resolution=input_resolution, n_head=n_head, n_layer=n_layer, layer_id=layer_id,
...
class RWKVIR(nn.Module):
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        embed = [48, 12,6,6, 16, 24]  # RWKV embedding dimension
...
def buildRWKVIR():
    return RWKVIR(img_size=(64, 64), depths=[6, 6, 6, 6], 
                   ...
                   img_range=1, embed_dim=48, upscale=2,
